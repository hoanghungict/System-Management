...
CREATE TABLE IF NOT EXISTS `class` (
  ...
  CONSTRAINT `class_department_id_foreign` FOREIGN KEY (`department_id`) REFERENCES `department` (`id`) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS `lecturer` (
  ...
  `experience_number` int NOT NULL DEFAULT '0',
  ...
  KEY `idx_lecturer_email` (`email`),
  KEY `idx_lecturer_department` (`department_id`),
  CONSTRAINT `lecturer_department_id_foreign` FOREIGN KEY (`department_id`) REFERENCES `department` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `task` (
  ...
  `include_new_students` tinyint(1) NOT NULL DEFAULT '0',
  `include_new_lecturers` tinyint(1) NOT NULL DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  KEY `idx_task_priority_created` (`priority`,`created_at`),
  KEY `idx_task_deadline_status` (`deadline`,`status`),
...
CREATE TABLE IF NOT EXISTS `task_file` (
  ...
  KEY `idx_task_file_path` (`file_path`),
...
CREATE TABLE IF NOT EXISTS `task_receivers` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `task_receivers_task_id_index` (`task_id`),
  KEY `task_receivers_receiver_type_receiver_id_index` (`receiver_type`,`receiver_id`),
  KEY `idx_task_receivers_type_id_task` (`receiver_type`,`receiver_id`,`task_id`),
  KEY `idx_task_receivers_task_type` (`task_id`,`receiver_type`),
