...
/**
 * Action: Get assigned tasks for lecturer
 */
class GetAssignedTasksAction extends BaseLecturerAction
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        try {
            ...
            return $this->errorResponse('Failed to retrieve assigned tasks', $e);
        }
    }
}
