...
-- Dumping structure for table system_services.task_dependencies
CREATE TABLE IF NOT EXISTS `task_dependencies` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `predecessor_task_id` bigint unsigned NOT NULL COMMENT 'Task mà dependency này phụ thuộc vào',
  `successor_task_id` bigint unsigned NOT NULL COMMENT 'Task hiện tại',
  `dependency_type` enum('finish_to_start','start_to_start','finish_to_finish','start_to_finish') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'finish_to_start' COMMENT 'Loại dependency',
  `lag_days` int NOT NULL DEFAULT '0' COMMENT 'Số ngày delay',
  `metadata` json DEFAULT NULL COMMENT 'Thông tin bổ sung',
  `created_by` bigint unsigned DEFAULT NULL COMMENT 'Người tạo',
  `created_by_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Loại người tạo (admin, lecturer, student)',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
